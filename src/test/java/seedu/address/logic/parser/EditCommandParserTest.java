...
import static seedu.address.testutil.TypicalIndexes.INDEX_THIRD_PLAYER;
...
public class EditCommandParserTest {
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditPlayerDescriptor descriptor = new EditPlayerDescriptorBuilder().withPhone(VALID_PHONE_BOB)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditPlayerDescriptorBuilder().withPhone(VALID_PHONE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // email
        userInput = targetIndex.getOneBased() + EMAIL_DESC_AMY;
        descriptor = new EditPlayerDescriptorBuilder().withEmail(VALID_EMAIL_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // address
        userInput = targetIndex.getOneBased() + ADDRESS_DESC_AMY;
        descriptor = new EditPlayerDescriptorBuilder().withAddress(VALID_ADDRESS_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
