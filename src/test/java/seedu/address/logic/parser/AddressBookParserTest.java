...
public class AddressBookParserTest {
    ...
    public void parseCommand_add() throws Exception {
        ...
        AddCommand command = (AddCommand) parser.parseCommand(PlayerUtil.getAddCommand(person));
    ...
    public void parseCommand_edit() throws Exception {
        Player person = new PlayerBuilder().build();
        EditPlayerDescriptor descriptor = new EditPlayerDescriptorBuilder(person).build();
        EditCommand command = (EditCommand) parser.parseCommand(EditCommand.COMMAND_WORD + " "
                + INDEX_FIRST_PERSON.getOneBased() + " " + PlayerUtil.getEditPlayerDescriptorDetails(descriptor));
